...
public class Database {
    ...
    private void init() {
        ...
        Publisher p = new Publisher("한빛 미디어", "대구");


        bookDB.put(1, new Book("데이터베이스", p, 300, false));
        bookDB.put(2, new Book("운영체제", p, 300, false));
        bookDB.put(3, new Book("컴파일러", p, 300, true));
        bookDB.put(4, new Book("C++", p, 300, false));
        bookDB.put(5, new Book("리눅스 커널", p, 300, false));
        bookDB.put(6, new Book("컴퓨터 네트워크", p, 300, true));
        bookDB.put(7, new Book("컴퓨터 구조", p, 300, false));
        bookDB.put(8, new Book("JPA 프로그래밍", p, 300, true));
        bookDB.put(9, new Book("매트랩", p, 300, true));
        bookDB.put(10, new Book("임베디드 시스템", p, 300, false));
    }
